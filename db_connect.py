...
class RequestLogDAO:
    ...
    def update_field(self, id_request, field_name, new_value):
        ...
        # Se il valore è un dict, lo convertiamo in JSON
...
class RequestLogServer:
    ...
    def insert_request(self, request_text, response_text):
        try:
            ...
            print(f"✅ Inserito record con ID: {inserted_id}")
            return inserted_id
    ...
    def update_field(self, id_request, field_name, new_value):
        try:
            ...
            print(f"🔄 Campo '{field_name}' aggiornato per ID {id_request}")
            return updated
        except Exception as e:
            print(f"❌ Errore durante l'update generico: {e}")
            return None
        finally:
            self.dao.close()
...
class RequestLogApiServer:
    ...
    def delete_request(self, id_request):
        try:
            ...
            print(f"🗑️ Eliminato record con ID: {id_request}")
            return deleted
        except Exception as e:
